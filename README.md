...
there are two expansions to this modpack that focus on different things. **i think the pack is best experienced and balanced by itself**, but if you want to theme canvas into something either more rpg or tech focused then go for it, there's a readme in the 'expansions' folder within the pack. however, if you plan on playing on a server you're going to have to create the serverpack version for those expansions yourself.
