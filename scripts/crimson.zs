...
<item:the_aether:phoenix_bow>.anyDamage().addGlobalAttributeModifier(<attribute:projectile_damage:generic>, IItemStack.BASE_ATTACK_DAMAGE_UUID, "PHBow Damage Display", 7, AttributeOperation.ADDITION, [<constant:minecraft:equipmentslot:mainhand>]);