...
<item:enderscape:drift_leggings>.anyDamage().addGlobalAttributeModifier(<attribute:minecraft:generic.armor_toughness>, "d8499b04-0e66-4726-ab29-64469d734e0d", "drifter tough legs", 3, AttributeOperation.ADDITION, [<constant:minecraft:equipmentslot:legs>]);
<item:enderscape:drift_leggings>.anyDamage().addGlobalAttributeModifier(<attribute:minecraft:generic.armor>, "d8499b04-0e66-4726-ab29-64469d734e0d", "drifter armor legs", 7, AttributeOperation.ADDITION, [<constant:minecraft:equipmentslot:legs>]);

<item:minecraft:turtle_helmet>.anyDamage().addGlobalAttributeModifier(<attribute:minecraft:generic.armor>, "2ad3f246-fee1-4e67-b886-69fd380bb150", "turtle armor", 3, AttributeOperation.ADDITION, [<constant:minecraft:equipmentslot:head>]);
<item:minecraft:turtle_helmet>.anyDamage().addGlobalAttributeModifier(<attribute:minecraft:generic.armor_toughness>, "2ad3f246-fee1-4e67-b886-69fd380bb150", "turtle armor tough", 3, AttributeOperation.ADDITION, [<constant:minecraft:equipmentslot:head>]);
