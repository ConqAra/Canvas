...
<item:crimsonmoon:crimson_bone_blade>.anyDamage().addGlobalAttributeModifier(<attribute:minecraft:generic.attack_speed>, IItemStack.BASE_ATTACK_SPEED_UUID, "BoneBlade Speed Display", -2, AttributeOperation.ADDITION, [<constant:minecraft:equipmentslot:mainhand>]);
...
<item:crimsonmoon:crimson_crusher>.anyDamage().addGlobalAttributeModifier(<attribute:minecraft:generic.attack_damage>, IItemStack.BASE_ATTACK_DAMAGE_UUID, "Crimson Crusher Buff", 10.5, AttributeOperation.ADDITION, [<constant:minecraft:equipmentslot:mainhand>]);
...
<item:byg:pendorite_battleaxe>.anyDamage().addGlobalAttributeModifier(<attribute:minecraft:generic.attack_speed>, IItemStack.BASE_ATTACK_SPEED_UUID, "BattleAxe Buff", -3.2, AttributeOperation.ADDITION, [<constant:minecraft:equipmentslot:mainhand>]);
